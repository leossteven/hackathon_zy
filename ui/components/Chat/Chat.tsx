...
// Now modify your handleScroll function to use this flag
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1579546929662-711aa81148cf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80')",
    ...
    >
      <>
        ...
        >
          ...
          <div
            className="h-[162px] bg-blue-50 dark:bg-[#343541]"
            ref={messagesEndRef}
          >
          </div>
        </div>
